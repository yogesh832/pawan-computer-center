...
function Result() {
  ...
  return (
    <div className="flex justify-center items-center w-full bg-gray-100 p-10">
      <div className="relative bg-white shadow-lg p-8 rounded-xl w-full max-w-4xl mx-4">
        {/* Background Image */}
        <img
          src={bgImg}
          alt="Background"
        ...
        <div className="relative z-10">
          ...
          <div className="text-center mb-8">
            <svg width="500" height="95" className="mx-auto">
              <defs>
                <path
                  id="curve"
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-xs text-gray-500">
              NSDC Affiliated | ISO 9001 Certified
            </p>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-6">
            <div className="grid grid-cols-2 gap-4 text-sm text-gray-700">
              <p>
                ...
                {resultData.registerationNumber}
              </p>
              <p>
                <strong>Student Name:</strong> {resultData.studentName}
              </p>
              <p>
                <strong>S/O, D/O, W/O:</strong> {resultData.motherName}
              </p>
              <p>
                <strong>Date of Birth:</strong> {resultData.dob}
              </p>
              <p>
                <strong>Duration:</strong> {resultData.duration}
              </p>
              <p>
                <strong>Course Name:</strong> {resultData.courseName}
              </p>
              <p>
                <strong>Center Name:</strong> {resultData.centerName}
              </p>
              <p>
                <strong>Course Code:</strong> {resultData.courseCode}
              </p>
              <p>
            ...
            <table className="min-w-full table-auto">
              ...
              <tbody>
                {resultData.subjects.map((subject, index) => (
                  <tr
                    key={index}
                    className="border-t border-gray-300 text-gray-700"
                  >
