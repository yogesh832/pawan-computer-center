      ...
      <div className="p-4">
        <div className="overflow-x-auto">
          <table className="border-collapse border border-gray-300 w-full">
            <thead>
              <tr>
                <th className="p-2 text-left font-bold text-gray-500 border border-gray-300">
                  Date
                </th>
                <th className="p-2 text-left font-bold text-gray-500 border border-gray-300">
                  Transaction From
                ...
                <th className="p-2 text-right font-bold text-gray-500 border border-gray-300">
                  Credit Amount
                </th>
                <th className="p-2 text-right font-bold text-gray-500 border border-gray-300">
                  Debit Amount
            ...
            <tbody>
              <tr>
                ...
                <td className="p-2 text-left border border-gray-300">
                  Student activation charge, for Student Id: RVSP2408105464
                  Activation Date: 2024-08-03
                </td>
              ...
              <tr>
                ...
                <td className="p-2 text-left border border-gray-300"></td>
                <td className="p-2 text-left border border-gray-300">
                  Student activation charge, for Student Id: RVSP2407105428
                  Activation Date: 2024-07-06
                </td>
                <td className="p-2 text-right border border-gray-300">0</td>
                <td className="p-2 text-right border border-gray-300">500</td>
                <td className="p-2 text-right border border-gray-300">500</td>
              ...
              <tr>
                ...
                <td className="p-2 text-left border border-gray-300"></td>
                <td className="p-2 text-left border border-gray-300">
                  Student activation charge, for Student Id: RVSP2406105424
                  Activation Date: 2024-06-30
                </td>
                <td className="p-2 text-right border border-gray-300">0</td>
                <td className="p-2 text-right border border-gray-300">500</td>
                <td className="p-2 text-right border border-gray-300">0</td>
              ...
              <tr>
                ...
                <td className="p-2 text-left border border-gray-300">
                  Center Successfully added by Head Office
                </td>
                <td className="p-2 text-right border border-gray-300">0</td>
                <td className="p-2 text-right border border-gray-300">0</td>
                <td className="p-2 text-right border border-gray-300">0</td>
