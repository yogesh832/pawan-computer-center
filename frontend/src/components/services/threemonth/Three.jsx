...
const courseData = [
  ...
  },
  {
    ...
    semester: "Semester 1",
    description:
      "Computer Fundamentals Constriction & Functioning of different PC parts Monitor,Mother Board,Hard Disk,CD-ROM etc.Software Installation.",
    image: img,
  },
  {
  ...
  },
  {
    ...
    semester: "Semester 1",
    description:
      "Computer Fundamentals English Typing (39wpm),Hindi Typing (32wpm) using Hindi Font.",
    image: img,
  },
  {
    ...
    semester: "Semester 1",
    description:
      "Computer Fundamentals Windows 7, Ms Office 2010English Typing,Internet.",
    image: img,
  },
  {
  ...
  },
  {
    ...
    semester: "Semester 1",
    description:
      "Teddy,Teddy Pillow, Love Bears,Freeze And Phone Covers,Bags,Car Hangings,Cushion,Bugs Bunny Etc.",
    image: img,
  },
  {
    ...
    semester: "Semester 1",
    description:
      "Stoking Flowers,Ribbon Flowers,Flower With Paper,Flower With Wool Glitter Flower,Board Decoration Etc.",
    image: img,
  },
  {
    ...
    semester: "Semester 1",
    description:
      "Basic Course of English Basic Conversation & Translation. Language,Reading,Writing,Basic Vocabulary,",
    image: img,
  },
  {
    ...
    semester: "Semester 1",
    description:
      "Professional Makeup,H.D. and Non H.D Makeup,Party Makeup,Personal Grooming",
    image: img,
  },
  {
    ...
    semester: "Semester 1",
    description:
      "Fabric painting,Aari WorkGlass Painting,Handmade Jewelry ,Painting, Quilling Craft Recycled,Craft Soft Toys Engraving Work",
    image: img,
  },
  {
  ...
  },
  {
    ...
    semester: "Semester 1",
    description:
      " Introduction to Basic BIM & Revit Architecture,Place & Modify Walls,Add & Modify wall Profiles,Place Doors, Windows & Components,Dimensioning, Create Floors & Ceilings,Curtain Walls & Stairs,Basic Conceptual Modeling,Annotation & Schedules,Basic Structural Elements,Schedules, Sheets & Title Blocks,Views, Camera , Walk through",
    image: img,
  },
  {
    ...
    semester: "Semester 1",
    description:
      "Explanation of Basic Safety Functions,Machine Components & Their Functions,Basic PRO 6 Screen Navigation,Coordinate Systems,Setting Work Coordinate Offsets,Tools & Tool Offsets,Program Management & Editing,Malfunction Prevention & Program Recovery,Tool Monitoring.",
    image: img,
  },
  {
  ...
  },
  {
    ...
    semester: "Semester 1",
    description:
      "Fundamentals of Numerical Control,Working Principle of CNC machines,Control Panel,Axis of Motion Programmer Structure G-Code,M- Code CNC Parts,Programming and Operating.",
    image: img,
  },
];
