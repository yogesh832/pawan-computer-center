...
const courseData = [
  ...
  },
  {
    ...
    semester: "Semester 1",
    description:
      "Computer Fundamentals windows 7,Accounting Concept,Tally,Internet.",
    image: img,
  },

  {
    ...
    semester: "Semester 1",
    description:
      "Computer Fundamentals windows7,PageMaker, Coral Draw,Photoshop,Regional Typinginternet",
    image: img,
  },

  {
    ...
    semester: "Semester 1",
    description:
      "Computer Fundamentals windows 7,Construction & functioning of different PC parts, Monitor, Mother Board, Hard Disk, VD-ROM etc.Software installation, Troubleshooting etc.",
    image: img,
  },
...

  {
    ...
    semester: "Semester 1",
    description:
      "Computer Fundamentals windows 7,Internet,HTML including Javascript",
    image: img,
  },
...

  {
    ...
    semester: "Semester 1",
    description:
      "Computer Fundamentals Basic Concept of programming Languages:Language C,Language C++,HTML with CSS,Core PHP project Work",
    image: img,
  },

  {
    ...
    semester: "Semester 1",
    description:
      "Computer Fundamentals MS Office Internet,Accounting Concept Tally",
    image: img,
  },
...

  {
    ...
    semester: "Semester 1",
    description:
      "Computer Fundamentals windows 7,Photoshop,Corel Draw,Flash, Premiere Pro,After Effects",
    image: img,
  },
...

  {
    ...
    semester: "Semester 1",
    description:
      "Computer Fundamentals C++,C# .NET,VB.NET,ASP.NET,SQL SERVER 2008,JAVA,ADV JAVA,MYSQL,INTERNSHIP",
    image: img,
  },

  {
    ...
    semester: "Semester 1",
    description:
      "Computer Concepts & Fundamentals of computer,Operating system (Dos, Windows XP/7),MS-Office XP/ 2007 ( Ms Word, Ms excel, Ms Power Point ,Access),Introduction to Internet & E-mail,Html,css,java Script,AS/PHP,",
    image: img,
  },

  {
    ...
    semester: "Semester 1",
    description:
      "Computer Fundamentals Ms office 2010 Word Excel Power Point Tally ERP",
    image: img,
  },

  {
    ...
    semester: "Semester 1",
    description:
      "Computer Fundamentals Ms Office 2010 Word Excel Power Point Access Internet",
    image: img,
  },

  {
    ...
    semester: "Semester 1",
    description:
      "Computer Fundamentals English typing (41wpm) Hindi Typing using Hindi Font (34wpm)",
    image: img,
  },

  {
    ...
    semester: "Semester 1",
    description:
      "Computer Fundamentals Ms Office 2010 Word, Excel, Power Point English Typing, Hindi typing Internet.",
    image: img,
  },

  {
    ...
    semester: "Semester 1",
    description:
      "Introduction to Digital Marketing Search Engine Optimisation (SEO)Search Engine Marketing (SEM)Social Media Marketing Content Strategy Web AnalyticsEmail MarketingE-Commerce",
    image: img,
  },
...

  {
    ...
    semester: "Semester 1",
    description:
      "Basic Mobile Phone,Various Mobile Circuit,Mobile Software,Mobile Phone Faults,Mobile Phone Repairing,Downloading Techniques.",
    image: img,
  },
...

  {
    ...
    semester: "Semester 1",
    description:
      "Grooming, Hygiene & Safety Basic HaircutsHair Spa & Hair Treatments Treatments for Hair Fall and Dandruff Massage Manipulation PermHair Spa/ Hair Oil Massage Keratin Understanding Skin Type & AnalysisGrey Coverage and Root Touchups",
    image: img,
  },
  ...
  },
  {
    ...
    semester: "Semester 1",
    description:
      "Prepare and Maintain work area, Professional Makeup,International Product Knowledge,Hair Style Detailing",
    image: img,
  },
  {
    ...
    semester: "Semester 1",
    description:
      "Drawing,Febric painting,Aari Work,Glass Painting,Handmade Jewelry Making,Pot Painting,Quilling Craft,Recycled Craft,Soft Toys,Engraving Work,Online Business Training",
    image: img,
  },
  {
    ...
    semester: "Semester 1",
    description:
      "Basic Concept of Painting,Glass Painting,Emboss Painting,Fabric Painting,Pot Painting,PaintingWith Bamboo,Working With Ribbon And Board Decoration.",
    image: img,
  },
  {
    ...
    semester: "Semester 1",
    description:
      "Basic & Advance Course of English Language,Phonetics,Vocabulary,Story Making,Basic Presentation,Writing,Speech,Reading skills,Conversation.",
    image: img,
  },
];
