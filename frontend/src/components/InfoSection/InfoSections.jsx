...
const InfoSections = () => {
  const infoItems = [
    ...
    },
    {
      ...
      description:
        "A collection of books and other materials accessible for use.",
    },
    {
      icon: (
      ...
      title: "Teachers",
      description:
        "Professional knowledge and skill gained through formal preparation and experience.",
    },
    {
      icon: (
  ...
  return (
    <div className="flex flex-wrap justify-between p-5 rounded-lg w-11/12 mx-auto">
      {infoItems.map(({ icon, title, description }, index) => (
        <div
          key={index}
          className="bg-gray-300 text-black p-5 rounded-lg w-full sm:w-[48%] lg:w-[20%] flex flex-col justify-between m-2 relative transform transition-transform duration-300 hover:scale-105"
        >
